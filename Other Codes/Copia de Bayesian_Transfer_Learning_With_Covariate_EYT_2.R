...
Traits_to_evaluate=colnames(Pheno)[c(4:7)]
...
write.csv(Predictions_Envs, file.path(results_dir, "predictions_EYT_2.csv"))
write.csv(Sumary_Envs , file.path(results_dir, "summary_EYT_2.csv"))
